...
const utils = {
	...
	/*
	* Returns a function to modify a requests User-Agent header.
	* @param {string} customUserAgent - desired User-Agent
	*/
	modifyUserAgent(customUserAgent) {
		return function (request) {
			request.httpRequest.headers['User-Agent'] = customUserAgent;
		}
	},
};
